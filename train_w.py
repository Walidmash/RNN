...
from hardTimesDataset import HardTimesDataset, RandomCrop, OneHotEncoder, ToTensor
...
# Dataset
parser.add_argument('--datasetpath',    type=str,   default='dataset/dataset.txt', help='Path of the train txt file')
parser.add_argument('--crop_len',       type=int,   default=20,               help='Number of input letters')
parser.add_argument('--alphabet_len',   type=int,   default=8752,                help='Number of letters in the alphabet')
...
# Save
parser.add_argument('--out_dir',     type=str,   default='model_w',    help='Where to save models and params')
...
if __name__ == '__main__':
    ...
    dataset = HardTimesDataset(filepath=args.datasetpath, crop_len=args.crop_len, transform=trans)
